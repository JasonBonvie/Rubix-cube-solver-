...
void InputUI::printCube() {
    ...
    for (int i=0; i<6; i++) {
        ...
        switch(i) {
          case 0:
        cout << BOLDRED << "Red side" << " (Yellow side facing perpendicular to your body)" << RESET << endl;
        break;
          case 1:
        cout << BOLDGREEN << "Green side" << "(Yellow side facing perpendicular to your body)" << RESET << endl;
        break;
          case 2:
        cout << BOLDORANGE << "Orange side "<< "(Yellow side facing perpendicular to your body)" << RESET << endl;
        break;
          case 3:
        cout << BOLDCYAN << "Blue side" << "(Yellow side facing perpendicular to your body)" << RESET << endl;
        break;
          case 4:
        cout << BOLDYELLOW << "Yellow side" << " (Orange side facing perpendicular to your body)" << RESET << endl;
        break;
          case 5:
        cout << BOLDWHITE <<"White side " << " (Red side facing perpendicular to your body)" << RESET << endl;
        break;
        }
